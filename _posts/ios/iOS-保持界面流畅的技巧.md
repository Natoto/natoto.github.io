...
[![weibo](http://blog.ibireme.com/wp-content/uploads/2015/11/weibo.png)](http://blog.ibireme.com/wp-content/uploads/2015/11/weibo.png)[![weibo_compose](http://blog.ibireme.com/wp-content/uploads/2015/11/weibo_compose.png)](http://blog.ibireme.com/wp-content/uploads/2015/11/weibo_compose.png)[![twitter](http://blog.ibireme.com/wp-content/uploads/2015/11/twitter.png)](http://blog.ibireme.com/wp-content/uploads/2015/11/twitter.png)
...
[![ios_screen_scan](http://blog.ibireme.com/wp-content/uploads/2015/11/ios_screen_scan.png)](http://blog.ibireme.com/wp-content/uploads/2015/11/ios_screen_scan.png)

首先从过去的 CRT 显示器原理说起。CRT 的电子枪按照上面方式，从上到下一行行扫描，扫描完成后显示器就呈现一帧画面，随后电子枪回到初始位置继续下一次扫描。为了把显示器的显示过程和系统的视频控制器进行同步，显示器（或者其他硬件）会用硬件时钟产生一系列的定时信号。当电子枪换到新的一行，准备进行扫描时，显示器会发出一个水平同步信号（horizonal synchronization），简称 HSync；而当一帧画面绘制完成后，电子枪回复到原位，准备画下一帧前，显示器会发出一个垂直同步信号（vertical synchronization），简称 VSync。显示器通常以固定频率进行刷新，这个刷新率就是 VSync 信号产生的频率。尽管现在的设备大都是液晶显示屏了，但原理仍然没有变。

[![ios_screen_display](http://blog.ibireme.com/wp-content/uploads/2015/11/ios_screen_display.png)](http://blog.ibireme.com/wp-content/uploads/2015/11/ios_screen_display.png)
...
[![ios_vsync_off](http://blog.ibireme.com/wp-content/uploads/2015/11/ios_vsync_off.jpg)](http://blog.ibireme.com/wp-content/uploads/2015/11/ios_vsync_off.jpg)
...
[![ios_frame_drop](http://blog.ibireme.com/wp-content/uploads/2015/11/ios_frame_drop.png)](http://blog.ibireme.com/wp-content/uploads/2015/11/ios_frame_drop.png)
...
**<span style="color: #8dd400;">对象创建</span>**
...
**<span style="color: #8dd400;">对象调整</span>**
...
**<span style="color: #8dd400;">对象销毁</span>**

对象的销毁虽然消耗资源不多，但累积起来也是不容忽视的。通常当容器类持有大量对象时，其销毁时的资源消耗就非常明显。同样的，如果对象可以放到后台线程去释放，那就挪到后台线程去。这里有个小 Tip：把对象捕获到 block 中，然后扔到后台队列去随便发送个消息以避免编译器警告，就可以让对象在后台线程销毁了。

<pre class="crayon-plain-tag">NSArray *tmp = self.array;
self.array = nil;
dispatch_async(queue, ^{
    [tmp class];
});</pre>

**<span style="color: #8dd400;"> 布局计算</span>**
...
**<span style="color: #8dd400;">Autolayout</span>**
...
**<span style="color: #8dd400;">文本计算</span>**
...
**<span style="color: #8dd400;">纹理的渲染</span>**
...
**<span style="color: #8dd400;">视图的混合 (Composing)</span>**

当多个视图（或者说 CALayer）重叠在一起显示时，GPU 会首先把他们混合到一起。如果视图结构过于复杂，混合的过程也会消耗很多 GPU 资源。为了减轻这种情况的 GPU 消耗，应用应当尽量减少视图数量和层次，并在不透明的视图里标明 opaque 属性以避免无用的 Alpha 通道合成。当然，这也可以用上面的方法，把多个视图预先渲染为一张图片来显示。

**<span style="color: #8dd400;">图形的生成。</span>**
...
[![scott_goodson](http://blog.ibireme.com/wp-content/uploads/2015/11/scott_goodson.png)](http://blog.ibireme.com/wp-content/uploads/2015/11/scott_goodson.png)
...
[![asdk_history](http://blog.ibireme.com/wp-content/uploads/2015/11/asdk_history.png)](http://blog.ibireme.com/wp-content/uploads/2015/11/asdk_history.png)
...
[![asdk_design](http://blog.ibireme.com/wp-content/uploads/2015/11/asdk_design.png)](http://blog.ibireme.com/wp-content/uploads/2015/11/asdk_design.png)
...
[![asdk_layer_backed_view](http://blog.ibireme.com/wp-content/uploads/2015/11/asdk_layer_backed_view.png)](http://blog.ibireme.com/wp-content/uploads/2015/11/asdk_layer_backed_view.png)
...
[![asdk_view_backed_node](http://blog.ibireme.com/wp-content/uploads/2015/11/asdk_view_backed_node.png)](http://blog.ibireme.com/wp-content/uploads/2015/11/asdk_view_backed_node.png)
...
[![asdk_layer_backed_node](http://blog.ibireme.com/wp-content/uploads/2015/11/asdk_layer_backed_node.png)](http://blog.ibireme.com/wp-content/uploads/2015/11/asdk_layer_backed_node.png)
...
[![asdk_comoose_1](http://blog.ibireme.com/wp-content/uploads/2015/11/asdk_comoose_1.png)](http://blog.ibireme.com/wp-content/uploads/2015/11/asdk_comoose_1.png) [![asdk_compose_2](http://blog.ibireme.com/wp-content/uploads/2015/11/asdk_compose_2.png)](http://blog.ibireme.com/wp-content/uploads/2015/11/asdk_compose_2.png)
...
[![asdk_a9_chip](http://blog.ibireme.com/wp-content/uploads/2015/11/asdk_a9_chip.jpg)](http://blog.ibireme.com/wp-content/uploads/2015/11/asdk_a9_chip.jpg)
...
[![ios_vsync_runloop](http://blog.ibireme.com/wp-content/uploads/2015/11/ios_vsync_runloop.png)](http://blog.ibireme.com/wp-content/uploads/2015/11/ios_vsync_runloop.png)
...
我只在显示文本的控件上用到了异步绘制的功能，但效果很不错。我参考 ASDK 的原理，实现了一个简单的异步绘制控件。这块代码我单独提取出来，放到了这里：[YYAsyncLayer](https://github.com/ibireme/YYAsyncLayer)。YYAsyncLayer 是 CALayer 的子类，当它需要显示内容（比如调用了 [layer setNeedDisplay]）时，它会向 delegate，也就是 UIView 请求一个异步绘制的任务。在异步绘制时，Layer 会传递一个 <span style="color: #008000;">BOOL(^isCancelled)()</span> 这样的 block，绘制代码可以随时调用该 block 判断绘制任务是否已经被取消。
...
[![ios_dispatch_blocked_1](http://blog.ibireme.com/wp-content/uploads/2015/11/ios_dispatch_blocked_1.png)](http://blog.ibireme.com/wp-content/uploads/2015/11/ios_dispatch_blocked_1.png) [![ios_dispatch_blocked_2](http://blog.ibireme.com/wp-content/uploads/2015/11/ios_dispatch_blocked_2.png)](http://blog.ibireme.com/wp-content/uploads/2015/11/ios_dispatch_blocked_2.png)
